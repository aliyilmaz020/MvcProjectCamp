...
namespace BusinessLayer.ValidationRules
{
    public class WriterValidator : AbstractValidator<Writer>
    {
        public WriterValidator()
        {
            ...
            RuleFor(x => x.WriterImage).NotEmpty().WithMessage("Bu alan boş geçilemez.").MaximumLength(300).WithMessage("En fazla 300 karakter giriniz.").MinimumLength(10)
            ...
            RuleFor(x => x.WriterPassword).NotEmpty().WithMessage("Bu alan boş geçilemez").MaximumLength(20).WithMessage("En fazla 20 karakter giriniz.").MinimumLength(10).WithMessage("En az 10 karakter giriniz.")
